  ...
  return (
    <AnimatePresence>
      {shouldDisplayDetails && (
        ...
        >
          <div className="bg-black/40 backdrop-blur-sm p-6 rounded-xl border border-warning-100/20">
            ...
            <h4 className='tracking-tight text-2xl mb-5 ml-1 text-warning font-semibold'>
