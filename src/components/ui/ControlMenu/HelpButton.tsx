    ...
    <ModalContent>
      {(onClose) => (
        <>
          ...
          <ModalBody>
            <p><span className="text-warning">Mobile: </span>Pinch to zoom, drag to rotate around focus.</p>
            <p><span className="text-warning">Desktop: </span>Left click + drag to move, scroll to zoom.</p>
            ...
            <p><span className="text-warning">Note: </span> Free movement and speed are disabled when zoomed in on a planet</p>
          </ModalBody>
          <ModalFooter>
